...
#----------------------------------------------------------------------
def DirectedSpectralClustering(n_clusters, matrix, matrix_name, n_eigenspace, d_norm, preload=False):
    """"""
    if preload:
...
#        print(eigvals)
        ...
        print(eigvals.argsort()[-n_eigenspace:])
        print(eigvals[eigvals.argsort()[:n_eigenspace]], eigvals[eigvals.argsort()[-n_eigenspace:]])
#        exit()
    else:
